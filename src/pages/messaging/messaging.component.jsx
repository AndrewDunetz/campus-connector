...
//     const [user] = useAuthState(auth);
//     target = firestore.collection('users').doc('YlQR0H8PKYfiAFXjz3PCNUD9qc72');
...
//     convoQuery1 ? currentConversation = useCollectionData(convoQuery1, {idField: 'id'}) : currentConversation = useCollectionData(convoQuery2, {idField: 'id'});
